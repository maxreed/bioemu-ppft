...
#SBATCH --output=run_bioemu_batch_v5.log

module load StdEnv/2023 python/3.11 cuda/12.2 gcc/12.3
source bioemu_env/bin/activate

python my_scripts/run_bioemu_batch.py --m3a_dir data/msa_kras_mutants --out_dir outputs/v5_validation --num_states 1000 \
