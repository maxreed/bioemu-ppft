...
#SBATCH --output=test_validation_set_finetuned_v5.log
...
for s in "${MUTANTS[@]}"; do
  python my_scripts/new_loss.py --xtc outputs/v5_validation/KRAS_$s/samples.xtc --pdb outputs/v5_validation/KRAS_$s/topology.pdb --name KRAS_$s
done
