...
sample(sequence='data/msa_kras_mutants/WT.a3m', num_samples=1000, output_dir='test_RAS_WT_finetuned_v5', ckpt_path=ckpt_path, model_config_path=model_config_path)
